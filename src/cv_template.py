...
class Template(object):
	def __init__(self, args):
		...
		self.pub_mask_red = rospy.Publisher("/duckiebot/camera_note/image/mask_red", Image, queue_size = 1)
		self.pub_dist = rospy.Publisher("/duckiebot/camera_note/image/distancia", Point, queue_size = 1)
		self.pub_image_out = rospy.Publisher("/duckiebot/camera_note/image/image_out", Image, queue_size = 1)
		self.my_point = Point()
	...
	def procesar_img(self, msg):
		...
		lower_limit_yellow = np.array([20, 150, 150])
